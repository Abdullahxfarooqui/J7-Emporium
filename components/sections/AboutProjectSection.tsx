      ...
      <div className="container-j7">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.div
            ...
            className="relative"
          >
            {/* TODO: Replace with actual architectural render */}
            <div className="relative rounded-3xl overflow-hidden shadow-premium">
              <div className="aspect-[4/5] bg-gradient-to-br from-surface-secondary to-surface-tertiary flex items-center justify-center">
