      ...
      <div className="relative h-full flex flex-col items-center justify-center text-center px-6 z-20 container-j7">
        ...
        >
          <motion.h1
            ...
            style={{
              ...
              textShadow: '0 4px 20px rgba(0, 230, 118, 0.3)'
            }}
          >
            J7 Emporium
          </motion.h1>
        ...
        >
          <motion.div
            ...
            className="w-6 h-10 border-2 border-[#00e676] rounded-full flex items-start justify-center p-2"
          >
            <motion.div 
              className="w-1.5 h-2 bg-[#00e676] rounded-full"
              animate={{ y: [0, 12, 0] }}
              transition={{ 
                repeat: Infinity, 
                duration: 2,
